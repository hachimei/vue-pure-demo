...
const IndoorMap3d = function (mapdiv) {
  var _this = this
  var _theme = null
  var _mapDiv = mapdiv
  var _canvasWidth = _mapDiv.clientWidth
  var _canvasWidthHalf = _canvasWidth / 2
  var _canvasHeight = _mapDiv.clientHeight
  var _canvasHeightHalf = _canvasHeight / 2

  var _scene, _controls, _projector, _rayCaster
  var _canvasDiv
  var _selected
  var _showNames = true; var _showPubPoints = true
  var _curFloorId = 0
  var _selectionListener = null
  var _sceneOrtho, _cameraOrtho// for 2d
  var _spriteMaterials = []; var _pubPointSprites = null; var _nameSprites = null
  ...
  function select (obj) {
    ...
    // obj.scale = new THREE.Vector3(2, 2, 2) 放大无效
  }
  ...
  function makeTextSprite (message, parameters) {
    ...
    var fontColor = Object.prototype.hasOwnProperty.call(parameters, 'fontColor')
